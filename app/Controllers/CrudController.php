...
final class CrudController
{
    private const MODULES = [
        ...
        'logistics_rights' => ['table' => 'logistics_rights', 'title' => 'Direitos Logísticos', 'description' => 'Benefícios, vouchers e direitos associados ao deslocamento.'],
        'travel_itineraries' => ['table' => 'travel_itineraries', 'title' => 'Roteiros de Viagem', 'description' => 'Planejamento e execução de itinerários de viagem.'],
        'travel_legs' => ['table' => 'travel_legs', 'title' => 'Trechos de Viagem', 'description' => 'Trechos que compõem cada roteiro de deslocamento.'],
        'logistics_documents' => ['table' => 'logistics_documents', 'title' => 'Documentos Logísticos', 'description' => 'Documentação de embarque e comprovantes de viagem.'],
        'logistics_costs' => ['table' => 'logistics_costs', 'title' => 'Custos Logísticos', 'description' => 'Custos por unidade/equipe e composição por tipo.'],
        'employee_impediments' => ['table' => 'employee_impediments', 'title' => 'Impedimentos', 'description' => 'Bloqueios operacionais por colaborador (compliance, saúde, documentos).'],
